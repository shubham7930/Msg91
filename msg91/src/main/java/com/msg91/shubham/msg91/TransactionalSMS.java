...
/**
 * <b>This class is use to send Transactional SMS using MSG91 Platform</b>
 */
public class TransactionalSMS {
    /**
     * This method is use to send Transactional sms instantly.
     *
    ...
    public static void sendNow(final Context context, String AuthKey, String MobileNumber, String Message, String SenderID, int CountryCode, final ResponseListener responseListener) {
        String Url = ServerHelper.sendSMSURL() + "?message=" + Message + "&authkey=" + AuthKey + "&mobiles=" + MobileNumber + "&route=4&sender=" + SenderID + "&country=" + CountryCode;
        sendSMSRequest(context, Url, responseListener);
    }

    /**
     * This method is use to send Transactional sms with specific delay which is specified by minute.
     *
     * @param context          Current Context
     * @param AuthKey          Authentication key which is provided by MSG91.com
     * @param MobileNumber     Mobile number of the receiver of the message. Separate the number with <b>,</b> if the receiver is more than one.
    ...
    public static void sendLater(final Context context, String AuthKey, String MobileNumber, String Message, String SenderID, int CountryCode, int DelayInMinute, final ResponseListener responseListener) {
        String Url = ServerHelper.sendSMSURL() + "?afterminutes=" + DelayInMinute + "&message=" + Message + "&authkey=" + AuthKey + "&mobiles=" + MobileNumber + "&route=4&sender=" + SenderID + "&country=" + CountryCode;
        sendSMSRequest(context, Url, responseListener);
    }


    /**
     * This method is use to send Transactional sms at specific time.
     *
     * @param context          Current Context
     * @param AuthKey          Authentication key which is provided by MSG91.com
     * @param MobileNumber     Mobile number of the receiver of the message. Separate the number with <b>,</b> if the receiver is more than one.
    ...
    public static void sendSchedule(final Context context, String AuthKey, String MobileNumber, String Message, String SenderID, int CountryCode, String time, final ResponseListener responseListener) {
        String Url = ServerHelper.sendSMSURL() + "?schtime=" + time + "&message=" + Message + "&authkey=" + AuthKey + "&mobiles=" + MobileNumber + "&route=4&sender=" + SenderID + "&country=" + CountryCode;
        sendSMSRequest(context, Url, responseListener);
    }

    /**
     * This method is use to send flash Transactional sms instantly.
     *
     * @param context          Current Context
     * @param AuthKey          Authentication key which is provided by MSG91.com
     * @param MobileNumber     Mobile number of the receiver of the message. Separate the number with <b>,</b> if the receiver is more than one.
    ...
    public static void sendFlash(final Context context, String AuthKey, String MobileNumber, String Message, String SenderID, int CountryCode, final ResponseListener responseListener) {
        String Url = ServerHelper.sendSMSURL() + "?flash=1&message=" + Message + "&authkey=" + AuthKey + "&mobiles=" + MobileNumber + "&route=4&sender=" + SenderID + "&country=" + CountryCode;
        sendSMSRequest(context, Url, responseListener);

    }

    /**
     * This method is use to send flash Transactional sms with specific delay which is specified by minute.
     *
     * @param context          Current Context
     * @param AuthKey          Authentication key which is provided by MSG91.com
     * @param MobileNumber     Mobile number of the receiver of the message. Separate the number with <b>,</b> if the receiver is more than one.
    ...
    public static void sendFlashLater(final Context context, String AuthKey, String MobileNumber, String Message, String SenderID, int CountryCode, int DelayInMinute, final ResponseListener responseListener) {
        String Url = ServerHelper.sendSMSURL() + "?flash=1&afterminutes=" + DelayInMinute + "&message=" + Message + "&authkey=" + AuthKey + "&mobiles=" + MobileNumber + "&route=4&sender=" + SenderID + "&country=" + CountryCode;
        sendSMSRequest(context, Url, responseListener);
    }

    /**
     * This method is use to send flash Transactional sms at specific time.
     *
     * @param context          Current Context
     * @param AuthKey          Authentication key which is provided by MSG91.com
     * @param MobileNumber     Mobile number of the receiver of the message. Separate the number with <b>,</b> if the receiver is more than one.
    ...
    public static void sendFlashSchedule(final Context context, String AuthKey, String MobileNumber, String Message, String SenderID, int CountryCode, String time, final ResponseListener responseListener) {
        String Url = ServerHelper.sendSMSURL() + "?flash=1&schtime=" + time + "&message=" + Message + "&authkey=" + AuthKey + "&mobiles=" + MobileNumber + "&route=4&sender=" + SenderID + "&country=" + CountryCode;
        sendSMSRequest(context, Url, responseListener);
    }
